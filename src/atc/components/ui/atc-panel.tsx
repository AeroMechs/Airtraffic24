...
import type { AtcFeed, AtcFeedType } from "@/atc/lib/atc-types";
import { FEED_TYPE_PRIORITY } from "@/atc/lib/atc-types";
import { lookupAtcFeeds, findNearbyAtcFeeds } from "@/atc/lib/atc-lookup";
import { AtcWaveform } from "@/atc/components/ui/atc-waveform";
...
const AtcSpectrum = dynamic(
  () =>
    import("@/atc/components/ui/atc-spectrum").then((mod) => mod.AtcSpectrum),
  { ssr: false },
);
