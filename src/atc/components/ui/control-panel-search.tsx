...
import { formatAltitude, formatSpeed } from "@/atc/lib/unit-formatters";
import { lookupAirline, flightQueryMatches } from "@/atc/lib/airlines";
import { CountryFlag } from "@/atc/components/ui/country-flag";
import { AirlineLogo } from "@/atc/components/ui/airline-logo";
import { PositionSourceBadge } from "@/atc/components/ui/flight-badges";
import { searchFlightsGlobal } from "@/atc/lib/search-flight-client";
import {
  searchLocalLocations,
  searchGeocode,
  locationToCity,
  type SearchLocation,
} from "@/atc/lib/search-location-client";
...
export function SearchContent({
  ...
  return (
    <Command
      className="flex h-full flex-col atc-cmdk"
      filter={cmdkFilter}
      loop
      label={
        mode === "locations"
