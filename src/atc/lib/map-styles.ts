...
export const TERRAIN_DEM_SOURCE_ID = "atc-terrain-dem";
export const TERRAIN_HILLSHADE_LAYER_ID = "atc-terrain-hillshade";
...
const OPERATIONS_DARK_STYLE: Record<string, unknown> = {
  version: 8,
  sources: {},
  layers: [
    {
...
export const MAP_STYLES: MapStyle[] = [
  {
    ...
    style: OPERATIONS_DARK_STYLE,
    preview: "linear-gradient(135deg, #05070a 0%, #0b1320 50%, #05070a 100%)",
    previewUrl: "/atc-hero.png",
    dark: true,
  },
  {
    id: "dark",
